...
Revision ID: 1bd79fe627b8
Revises: 
Create Date: 2025-01-06 23:25:59.595430
...
def upgrade():
    ...
    sa.Column('rol', sa.Enum('usuario', 'entrenador', 'nutricionista', 'fisioterapeuta', 'admin', name='rol'), nullable=True),
